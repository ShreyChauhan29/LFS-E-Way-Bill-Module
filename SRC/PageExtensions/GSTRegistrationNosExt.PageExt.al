...
pageextension 73100 "LFS GST Registration Nos. Ext." extends "GST Registration Nos."
{
    layout
    {
        addafter("Input Service Distributor")
        {
            ...
            {
                ApplicationArea = All;
                ToolTip = 'Specifies the value of the E-Way Bill API UserName field.', Comment = '%';
            }
            field("LFS E-Way Bill API Password"; Rec."LFS E-Way Bill API Password")
            {
                ApplicationArea = All;
                ToolTip = 'Specifies the value of the E-Way Bill API Password field.', Comment = '%';
            }
            ...
            {
                ApplicationArea = All;
                ToolTip = 'Specifies the value of the E-Way Bill Private Key field.', Comment = '%';
            }
            field("LFS E-Way Bill PrivateValue"; Rec."LFS E-Way Bill PrivateValue")
            {
                ApplicationArea = All;
                ToolTip = 'Specifies the value of the E-Way Bill Private Value field.', Comment = '%';
            }
